...
public class EditorGrassPainter : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        grassPainter.brushSize = EditorGUILayout.Slider("Brush Size", grassPainter.brushSize, 0.1f, 20f);
        grassPainter.minSpawnHeight = EditorGUILayout.FloatField("Min Spawn Height", grassPainter.minSpawnHeight);
 
        if (grassPainter.toolbarInt == 0)
        {
            grassPainter.normalLimit = EditorGUILayout.Slider("Normal Limit", grassPainter.normalLimit, 0f, 1f);
            grassPainter.density = EditorGUILayout.Slider("Density", grassPainter.density, 0.1f, 1000f);
