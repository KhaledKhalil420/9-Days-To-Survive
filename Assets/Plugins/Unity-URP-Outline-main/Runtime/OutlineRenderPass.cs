...
public sealed class OutlineRenderPass : ScriptableRenderPass
{
	...
	public OutlineRenderPass(Material outlineMaterial, LayerMask layer1, LayerMask layer2, LayerMask layer3, LayerMask layer4) : base()
	{
		...
		this.layerMask1 = layer1;
		this.layerMask2 = layer2;
		this.layerMask3 = layer3;
		this.layerMask4 = layer4;
	}
	...
	public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
	{
		...
		using (IUnsafeRenderGraphBuilder builder = renderGraph.AddUnsafePass("Outline Render Objects Pass", out PassData passData, profilingSampler))
		{
			...
			passData.rendererListHandleR = CreateRendererList(renderGraph, renderingData, cameraData, layerMask1, 0);
			passData.rendererListHandleG = CreateRendererList(renderGraph, renderingData, cameraData, layerMask2, 0);
			passData.rendererListHandleB = CreateRendererList(renderGraph, renderingData, cameraData, layerMask3, 0);
			passData.rendererListHandleA = CreateRendererList(renderGraph, renderingData, cameraData, layerMask4, 0);
	...
	/// <summary>
	/// Creates and returns the renderer list used to render the objects in the specified layer mask.
	/// </summary>
	/// <param name="renderGraph"></param>
	...
	/// <returns></returns>
	private RendererListHandle CreateRendererList(RenderGraph renderGraph, UniversalRenderingData renderingData, UniversalCameraData cameraData, LayerMask layerMask, int passIndex)
	{
		...
		rendererListDesc.renderingLayerMask = ~0u;
