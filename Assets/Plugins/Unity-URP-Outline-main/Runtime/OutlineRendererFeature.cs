...
public sealed class OutlineRendererFeature : ScriptableRendererFeature
{
	...
	[Tooltip("Layer mask for the first outline group")]
	public LayerMask outlineLayer1 = -1;
	
	[Tooltip("Layer mask for the second outline group")]
	public LayerMask outlineLayer2 = -1;
	
	[Tooltip("Layer mask for the third outline group")]
	public LayerMask outlineLayer3 = -1;
	
	[Tooltip("Layer mask for the fourth outline group")]
	public LayerMask outlineLayer4 = -1;
	...
	public override void Create()
	{
		...
		outlineRenderPass = new OutlineRenderPass(outlineMaterial, outlineLayer1, outlineLayer2, outlineLayer3, outlineLayer4);
	}
